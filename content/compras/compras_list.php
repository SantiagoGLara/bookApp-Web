<script type="text/javascript">
    ...
    function compras() {
        ...
        for (var i = 0; i < totalElementos.length; i++) {
            ...
            var valor = parseFloat(texto.replace(/,/g, '').replace(/[^0-9.-]/g, '')) || 0;
            totalCompras += valor;
        ...
        document.getElementById("totalCompras").textContent = "Monto total de compras: $" + totalCompras.toFixed(2);
    }
        ...
        for (var h = 0; h < filas - 1; h++) {
            for (var i = h + 1; i < filas; i++) {
                ...
                if (columna === 3) {
                    ...
                    var numA = parseFloat(matriz[h][columna].replace(/,/g, '').replace(/[^0-9.-]/g, '')) || 0;
                    var numB = parseFloat(matriz[i][columna].replace(/,/g, '').replace(/[^0-9.-]/g, '')) || 0;
                ...
                if ((compraAsc && comp > 0) || (!compraAsc && comp < 0)) {
